...
@section('pageTitle', 'All in One FAQ')
@section('pageDesc', 'If your question isn\'t here, contact me.')
		...
		<div class="row">
			<div class="col s12">
				<div class="card-panel">
					...
					<ol type="1">
						<li>You will request your commission through the <a href="{{ route('commissions.create') }}">commission form.</a></li>
					...
					<a href="{{ route('packages') }}">Click here to view my prices.</a>
					<h4 id="commercial-use">What counts as commercial use?</h4>
					<p>Commercial use is when my work is used for any commercial purpose including, but not limited to, advertisements, for-profit websites/businesses logos, business letterheads, business stationery, T-shirts, posters, stickers, graphics within software, and packaging for any product.</p>
					<strong>Indirect Commercial Use</strong>
					<p>If you use my work, and you or your organization generates income, then it counts as commercial use. This includes, but not limited to, using your commission for publicity, such as utilizing the art on social media sites like Youtube, Tumblr, Twitch, or as website decoration, etc.</p>
					...
					<p>Yes, please provide <a href="{{ route('tos') }}#license">proper credits</a></p>
				</div>
			</div>
		</div>
	</div>
